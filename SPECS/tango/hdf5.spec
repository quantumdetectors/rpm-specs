...
Source0: http://www.hdfgroup.org/ftp/HDF5/releases/hdf5-%{version}%{?snaprel}/src/hdf5-%{version}%{?snaprel}.tar.gz
Source1: h5comp
...
Obsoletes: %{name}-mpich2 < 1.10.7-1
...
Obsoletes: %{name}-mpich2-devel < 1.10.7-1
...
Obsoletes: %{name}-mpich2-static < 1.10.7-1
...
%changelog
* Sun Oct 25 2020 Stu <stu@quantumdetectors.com> - 1.10.7-1
- 1.10.7-1

* Tue May 23 2017 Mike Burns <mburns@redhat.com> - 1.8.17-3
- rebuild for ppc64le
